...
class Useful {
  static instance;
  static template = promptTemplate;
  static env;
  static minimumWaitBeforeQueryingOpenAI;
  static maxPrioritySum;
  static openAIKey;
  static adminLogChannelID;
  static bardChannelID;
  static openai;
  static adminLogChannel;
  static bardChannel;
